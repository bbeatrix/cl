...
runnames = {'1256': 'cifar10_base_ept=200',
            ...
            '1279': 'cifar10_clfixedunforgettablesmem_ept=10',
            '1280': 'cifar10_clfixedunforgettablesmemsoftforgets_ept=10',
            '1281': 'cifar10_clfixedunforgettablesmemsoftforgetsheavyaugment_ept=200'}
...
runs = api.runs("bbea/cl", {"display_name": {"$regex": "^(1279|1280|1281)-.*$"}})
print(len(runs))
